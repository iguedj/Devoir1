...
public class frmPrincipal extends javax.swing.JFrame {
    ...
    private void btnPrimeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnPrimeMouseClicked
       ...
       else if(cboSexe.getSelectedItem().toString().compareTo("Femme")==0&& Integer.parseInt(txtAge.getText())>19 &&Integer.parseInt(txtAge.getText()) <31)
        {
           lblPrime.setText(lblPrime.getText() + " Vous payez la surprime \n"); 
        }
...
// Exercice n°2
    ...
    private void btnRemboursementMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnRemboursementMouseClicked
        // Exercice n°3
         if(rbOui.isSelected()== false && (rbNon.isSelected()== false))
        {
            JOptionPane.showMessageDialog(this, "Etes vous membre ?");
            
        }
        if(sldNbJours.getValue()>7)
        {
          lblRemboursement.setText("Aucun remboursement n'est possible");
    ...
    private void btnBinaireMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnBinaireMouseClicked
        ...
        {
            JOptionPane.showMessageDialog(this, "Saisir votre entier");
        }
        // A vous de jouer
